...
export default function ApartmentCard({ apartment }) {
    // const formattedDateStart = `${apartment.availability.start.getDate()} ${apartment.availability.start.toLocaleString("default", { month: "short" })}`;
    // const formattedDateEnd = `${apartment.availability.end.getDate()} ${apartment.availability.end.toLocaleString("default", { month: "short" })}`;
