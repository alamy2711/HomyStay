...
export default function UserLayout() {
    const { token, loading: userLoading } = useAuth();
...
function MobileHeader() {
    ...
    return (
        <>
            ...
            <header className="sticky top-0 flex h-[60px] items-center justify-between bg-white px-1 py-2.5 text-gray-100 shadow-md lg:hidden">
                <Link to="/">
                    <img
