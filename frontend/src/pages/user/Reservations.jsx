...
const RequestsPage = () => {
    ...
    const filteredReservations = reservations
        .filter((reservation) => {
            ...
            const matchesSearch =
                `${reservation.apartment.title} ${reservation.apartment.host.first_name} ${reservation.apartment.host.last_name}`
                    .toLowerCase()
                        ...
                        <div className="w-full md:w-1/3">
                            <div className="relative rounded-md shadow-sm">
                                ...
                                <input
                                    ...
                                    placeholder="Search by property or host owner name..."
